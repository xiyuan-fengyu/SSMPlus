...
public class MpGenerator {
    ...
    private static final String databasePropertiesPath = "property/database.properties";
    ...
    public static void main(String[] args) {
        ...
        try {
            properties.load(MpGenerator.class.getClassLoader().getResourceAsStream(databasePropertiesPath));
        } catch (IOException e) {
            e.printStackTrace();
        }
